...
class StoryViewController: UIViewController {
    ...
    private func setupLayout() {
        tableView.register(UINib(nibName: "StoryCellTableViewCell", bundle: Bundle.main) , forCellReuseIdentifier: "StoryCellTableViewCell")
    ...
    private func downloadSnaps() {
        ...
        API.request(endpoint) { [weak self] success, valueDictionary in
