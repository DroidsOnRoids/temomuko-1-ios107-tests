...
//  Snappy
//
//  Created by Marcin Jackowski on 17.05.2017.
...
class SnapViewController: UIViewController {
    ...
    func downloadImage() {
        ...
        Alamofire.request(request).responseData { [weak self] response in
            ...
            weakSelf.timer = Timer.scheduledTimer(timeInterval: 10.0, target: weakSelf, selector: #selector(weakSelf.timerAction), userInfo: nil, repeats: false)
